    ...
    switch(b){
      case 16:
        ...
        switch(r){
          ...
          break;
          default:
            server.sendContent("<td align=center>"+String(ii,HEX)+"</td>");
          break;
        }  
      break;
      case 32:
        ...
        switch(r){
          ...
          case 1:
            if ( isPrintable(char(i)) ){
              server.sendContent("<td align=center>"+String(char(i))+"</td>");
            }else{
              server.sendContent("<td align=center>-</td>");              
            }
          break;
          default:
            if ( i < 16 ){
              server.sendContent("<td align=center>0"+String(i,HEX)+"</td>");              
            }else{
              server.sendContent("<td align=center>"+String(i,HEX)+"</td>");
            }
          break;
        }  
      break;
